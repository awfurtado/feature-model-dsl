...
namespace UFPE.FeatureModelDSL
{
	...
	/// </summary>
	internal partial class FeatureModelDSLDocView : FeatureModelDSLDocViewBase
	{
		/// <summary>
		/// Constructs a new FeatureModelDSLDocView.
		/// </summary>
		public FeatureModelDSLDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class FeatureModelDSLDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new FeatureModelDSLDocView.
		/// </summary>
		...
		protected override bool LoadView()
		{
			...
			FeatureModelDSLDocDataBase docData = this.DocData as FeatureModelDSLDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for FeatureModelDSLDocViewBase should be an FeatureModelDSLDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UFPE.FeatureModelDSL.FeatureModelDSLDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UFPE.FeatureModelDSL.FeatureModelDSLDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UFPE.FeatureModelDSL.FeatureModelDSLToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UFPE.FeatureModelDSL.FeatureModelDSLToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.FeatureModelDSLDiagramMenu;
			}
		}
			...
			if(global::UFPE.FeatureModelDSL.FeatureModelDSLHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UFPE.FeatureModelDSL.FeatureModelDSLHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
