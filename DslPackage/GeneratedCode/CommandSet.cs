...
namespace UFPE.FeatureModelDSL
{
	...
	/// </summary>
	internal partial class FeatureModelDSLCommandSet : FeatureModelDSLCommandSetBase
	{
		/// <summary>
		/// Constructs a new FeatureModelDSLCommandSet.
		/// </summary>
		public FeatureModelDSLCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class FeatureModelDSLCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new FeatureModelDSLCommandSetBase.
		/// </summary>
		protected FeatureModelDSLCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewFeatureModelDSLExplorerCommand,
				typeof(FeatureModelDSLEditorFactory).GUID);
		...
		{
			FeatureModelDSLExplorerToolWindow explorer = this.FeatureModelDSLExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentFeatureModelDSLDocData != null && this.CurrentFeatureModelDSLDocData.Store != null)
			{
				this.CurrentFeatureModelDSLDocData.ValidationController.Validate(this.CurrentFeatureModelDSLDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentFeatureModelDSLDocData != null && this.CurrentFeatureModelDSLDocData.Store != null)
			{
				...
				this.CurrentFeatureModelDSLDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected FeatureModelDSLDocData CurrentFeatureModelDSLDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as FeatureModelDSLDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected FeatureModelDSLDocView CurrentFeatureModelDSLDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as FeatureModelDSLDocView;
			}
		}
		...
		/// </summary>
		protected FeatureModelDSLExplorerToolWindow FeatureModelDSLExplorerToolWindow
		{
			get
			{
				FeatureModelDSLExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(FeatureModelDSLExplorerToolWindow), true) as FeatureModelDSLExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				FeatureModelDSLExplorerToolWindow explorerWindow = this.FeatureModelDSLExplorerToolWindow;
