...
namespace UFPE.FeatureModelDSL
{
	...
	/// </summary>
	internal partial class FeatureModelDSLDocData : FeatureModelDSLDocDataBase
	{
		/// <summary>
		/// Constructs a new FeatureModelDSLDocData.
		/// </summary>
		public FeatureModelDSLDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a FeatureModelDSL document in memory.
	/// </summary>
	internal abstract partial class FeatureModelDSLDocDataBase : DslShell::ModelingDocData
	{
		...
		protected override string FormatList
		{
			get
			{
				return global::UFPE.FeatureModelDSL.FeatureModelDSLDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::UFPE.FeatureModelDSL.FeatureModelDSLDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		{
			return new DslShell::VsValidationController(this.ServiceProvider, typeof(FeatureModelDSLExplorerToolWindow));
		}
		/// <summary>
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::UFPE.FeatureModelDSL.FeatureModelDSLDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::UFPE.FeatureModelDSL.FeatureModelDSLDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::UFPE.FeatureModelDSL.FeatureModel modelRoot = null;
			...
			global::UFPE.FeatureModelDSL.FeatureModelDSLDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::UFPE.FeatureModelDSL.FeatureModelDSLSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::UFPE.FeatureModelDSL.FeatureModelDSLDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::UFPE.FeatureModelDSL.FeatureModelDSLDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected override bool CanSave(bool allowUserInterface)
		{
			...
			if (allowUserInterface)
			{
				...
				if (vc.ErrorMessages.Count != 0)
				{
					...
					global::System.Windows.Forms.DialogResult result = DslShell::PackageUtility.ShowMessageBox(this.ServiceProvider, global::UFPE.FeatureModelDSL.FeatureModelDSLDomainModel.SingletonResourceManager.GetString(errorMsg), VSShellInterop::OLEMSGBUTTON.OLEMSGBUTTON_YESNO, VSShellInterop::OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_SECOND, VSShellInterop::OLEMSGICON.OLEMSGICON_WARNING);
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::UFPE.FeatureModelDSL.FeatureModel modelRoot = (global::UFPE.FeatureModelDSL.FeatureModel)this.RootElement;
			...
			{
				global::UFPE.FeatureModelDSL.FeatureModelDSLDiagram diagram = diagrams[0] as global::UFPE.FeatureModelDSL.FeatureModelDSLDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::UFPE.FeatureModelDSL.FeatureModelDSLSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::UFPE.FeatureModelDSL.FeatureModelDSLSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::UFPE.FeatureModelDSL.FeatureModelDSLDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::UFPE.FeatureModelDSL.FeatureModelDSLSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::UFPE.FeatureModelDSL.FeatureModel modelRoot = this.RootElement as global::UFPE.FeatureModelDSL.FeatureModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::UFPE.FeatureModelDSL.FeatureModelDSLSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
